...
public class Key
{
	...
	public Key(Messaging.VKeys vk = Messaging.VKeys.NULL, Messaging.VKeys shiftKey = Messaging.VKeys.NULL,
...
public class Messaging
{
	...
	private static uint GetDwExtraInfo(Int16 repeatCount, VKeys key, byte extended, byte contextCode,
		byte previousState,
